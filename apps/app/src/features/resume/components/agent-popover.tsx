...
type AgentPanelContentProps = {
  resumeId: string
  onPendingChanges: (changes: Array<{ section: string; itemId?: string; field: string; original: string; proposed: string }>) => void
...
function MessageParts({
  ...
  onPendingChanges: (c: Array<{ section: string; itemId?: string; field: string; original: string; proposed: string }>) => void
  onChangesApplied: () => void
  onChangesRejected: () => void
